                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: red; font-weight: bold; text-align: center;">Forgot Password</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <p style="text-align: center;"><a href="login.php">Already Have an Account ? Sign In!</a></p>
                                    </div>
                                </div>
                            </div>
                        </form>
